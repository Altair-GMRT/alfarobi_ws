...
enum ImageEncode{
    ...
    // coba 21 mei 2023
    static constexpr float NECK_X = .01819f;
    static constexpr float NECK_Y = .0f;
    static constexpr float NECK_Z = .04472f;
    static constexpr float NECK2HEAD_X = .04832f;
    static constexpr float NECK2HEAD_Y = .0f;
    static constexpr float NECK2HEAD_Z = .04704f;
#endif
